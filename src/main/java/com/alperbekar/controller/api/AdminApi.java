package com.alperbekar.controller.api;

import com.alperbekar.business.dto.AdminDto;
...
public class AdminApi {
    ...
    // http://localhost:2222/admin/api/v1/object2
    ...
    @GetMapping(value = {"object3/{id}","object3"})
    ...
    @GetMapping("object6")
    public AdminDto getRest6(@RequestParam(name = "id",required = false,defaultValue = "2")Long id){
        AdminDto adminDto = AdminDto.builder()
                .adminId(id)
                .adminSurname("surname")
                .adminName("name")
    ...
    @GetMapping("object8")
    public ResponseEntity<AdminDto> getRest8(@PathVariable Long id){
        AdminDto adminDto = AdminDto.builder()
                .adminId(id)
                .adminName("name")
                .adminSurname("surname")
